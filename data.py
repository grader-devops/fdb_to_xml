...
# print("------------Начинаем выгружать накладные ИП 2 -------------------")
# genxml(" ИП 2.xml",6)
# print("!!!!!!!!------------ Выгружены накладные ИП 2 ------------- !!!!!!!!!!")
# print("-" * 100)

# print("------------Начинаем выгружать накладные ИП 4 -------------------")
# genxml(" ИП 4.xml",7)
# print("!!!!!!!!------------ Выгружены накладные ИП 4 ------------- !!!!!!!!!!")

# print("------------Начинаем выгружать накладные Магазин 1 -------------------")
# genxml(" Магазин 1.xml",7003)
# print("-" * 100)

# print("------------Начинаем выгружать накладные старая 2 -------------------")
# genxml(" старая 2.xml",7008)
# print("-" * 100)

# print("------------Начинаем выгружать накладные северное 3 -------------------")
# genxml(" северное 3.xml",7013)
# print("-" * 100)

# print("------------Начинаем выгружать накладные Магазин 4 -------------------")
# genxml(" магазин 4.xml",7015)
# print("-" * 100)
...
#     if str(row['UCH'])=="5":
#     #     genxml("ИП 1.xml",5)
#         print("Выгружены накладные ИП 1")
#         print("-" * 100)
#     elif str(row['UCH'])=="6":
#         genxml(" ИП 2.xml",6)
#         print("Выгружены накладные ИП 2")
...
#     # elif str(row['UCH'])=="1":
#     #     # genxml(" ИП 3.xml",1)
#     #     print("Выгружены накладные ИП 3")
#     #     print("-" * 100)
#     elif str(row['UCH'])=="7":
#         # genxml(" ИП 4.xml",7)
#         print("Выгружены накладные ИП 4")
...
#         # genxml(" Магазин 1.xml",7003)
#         print("Выгружены накладные Магазин 1")
#         print("-" * 100)
#     elif str(row['UCH'])=="7008":
#         # genxml(" старая 2.xml",7008)
#         print("Выгружены накладные старая 2")
#         print("-" * 100)
#     elif str(row['UCH'])=="7013":
#         # genxml(" северное 3.xml",7013)
#         print("Выгружены накладные северное 3")
#         print("-" * 100)
#     elif str(row['UCH'])=="7015":
#         # genxml(" магазин 4.xml",7015)
#         print("Выгружены накладные магазин 4")
#         print("-" * 100)
